...
import { getLastSeenPokemons } from '../../services/lastSeenStorage';
...
export default function PokemonListScreen() {
 ...
 async function loadLastSeen() {
   const pokemons = await getLastSeenPokemons();
   setLastSeen(pokemons);
 }
 ...
 const visibleItems =
   showOnlyFavorites ? favoriteItems : items;
